...
contract DivijShuklaToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor(address initialOwner) Ownable(initialOwner) {
        _name = "DivijShuklaToken";
        _symbol = "DST";
        _mint(msg.sender, 10000 * 10 ** decimals()); // Initial supply: 10,000 tokens
    }
